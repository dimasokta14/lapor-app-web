...
const JNNSection = () => {
  return (
    <section className="jnn-section section">
      <div className="container">
        <div className="jnn-content">
          <div className="jnn-image floating">
            <div className="logo-circle">
              <svg width="120" height="120" viewBox="0 0 24 24" fill="currentColor">
                <path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5z"/>
              </svg>
              <div className="logo-text">JNN</div>
            </div>
          </div>
          ...
          <div className="jnn-text">
            ...
            <div className="jnn-features">
              <div className="feature-item">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <polyline points="20 6 9 17 4 12"></polyline>
                </svg>
                <span>Lapor dengan cepat</span>
              </div>
              <div className="feature-item">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <polyline points="20 6 9 17 4 12"></polyline>
